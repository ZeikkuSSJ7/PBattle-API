...
public class Main {
     ...
     * @param pokemonEnemy the pokemons of the enemy
     ...
     * @param i position of in your team of your pokemon in battle
    ...
    public static void initialize(Pokemon[] pokemons){
        Attack[] aux = {new Attack("Thunderbolt", 95, "Electric", 15, "Special"), new Attack("Electric Tackle", 120, "Electric", 10, "Physical"), new Attack("Poyo", 2000, "Kirb", 20, "Special"), null};
        Attack[] aux2 = {new Attack("Surf", 95, "Water", 15, "Special"), new Attack("Headbutt", 90, "Normal", 15, "Physical"), new Attack("Hydro Pump", 120, "Water", 5, "Special"), new Attack("Ice Beam", 95, "Ice", 15, "Special")};
        Attack[] aux3 = {new Attack("Flamethrower", 95, "Fire", 15, "Special"), new Attack("Fly", 90, 95, "Flying", 15, "Physical"), new Attack("Rock Slide", 100, 80, "Rock", 10, "Physical"), new Attack("Flame Burst", 120, "Fire", 5, "Special")};
        Attack[] aux4 = {new Attack("Gigadrain", 80, "Grass", 10, "Special"), new Attack("Sludge Bomb", 90, "Poison", 15, "Special"), new Attack("Energy Ball", 90, "Grass", 10, "Special"), new Attack("Double Edge", 120, "Normal", 15, "Physical")};
        Attack[] aux5 = {new Attack("Flamethrower", 95, "Fire", 15, "Special"), new Attack("Dark Pulse", 95, "Dark", 15, "Special"), new Attack("Flame Burst", 120, "Fire", 5, "Special"), new Attack("Dragon Pulse", 90, "Dragon", 15, "Special")};
        Attack[] aux6 = {new Attack("Poyo", 2000, "Kirb", 20, "Special"), new Attack("Earrape", 3000, "Yosh", 20, "Special"), new Attack("Haaai", 2000, "Kirb", 5, "Special"), new Attack("Pomazo de F", 5000, "Kirb", 20, "Physical")};
